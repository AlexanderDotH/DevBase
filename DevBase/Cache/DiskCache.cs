...
namespace DevBase.Cache
{
    public class DiskCache<K,V>
    {
        ...
        public DiskCache(int expirationMS, string cacheFolder)
        {
        ...
        public DiskCache(string cacheFolder) : this(2000, cacheFolder) {}

        public void WriteToCache(K key, V value, bool writeToFile)
        {
